...
RUN apt-get update && apt-get install -y openssh-server tmux zsh man vim htop less most git wget ca-certificates curl ruby1.9.1-dev build-essential g++ libmysqlclient-dev libsqlite3-dev sudo
